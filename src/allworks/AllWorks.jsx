...
class AllWorks extends migi.Component {
  constructor(...data) {
    super(...data);
    let self = this;
    self.on(migi.Event.DOM, function() {
      $net.postJSON('/h5/find/allWorks', { skip, take }, function(res) {
        if(res.success) {
          skip += take;
  ...
  setData(data) {
    ...
    $(self.ref.list.element).on('click', 'a', function(e) {
      ...
      if(!url) {
        throw new Error('allworks url is null');
      }
